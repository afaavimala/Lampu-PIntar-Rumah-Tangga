...
export function loadServerRuntimeConfig(env: NodeJS.ProcessEnv): ServerRuntimeConfig {
  ...
  const bindings: Omit<EnvBindings, 'DB'> = {
    ...
    AUTH_LOGIN_BACKOFF_BASE_SEC: env.AUTH_LOGIN_BACKOFF_BASE_SEC,
    AUTH_LOGIN_BACKOFF_FACTOR: env.AUTH_LOGIN_BACKOFF_FACTOR,
    AUTH_LOGIN_BACKOFF_MAX_SEC: env.AUTH_LOGIN_BACKOFF_MAX_SEC,
    COMMAND_EXECUTE_RATE_LIMIT_MAX: env.COMMAND_EXECUTE_RATE_LIMIT_MAX,
    COMMAND_EXECUTE_RATE_LIMIT_WINDOW_SEC: env.COMMAND_EXECUTE_RATE_LIMIT_WINDOW_SEC,
